...
export default function CreateCoursePage() {
  ...
  const handleCourseCreated = (form: any, id: string) => {
    setFormState(form);
    setCourseId(id);
    setIsModalOpen(false);
  };

  const courseCreated = formState && courseId;

  return (
    <div className="flex flex-col items-start justify-start min-h-screen p-20">
      {!courseCreated && (
        <>
          <motion.div
          ...
          >
            <div className="flex flex-col items-center gap-4 text-center">
              ...
              <p className="text-zinc-500 max-w-md">
                Start your teaching journey by creating a new school. Add
                courses, upload videos, and share your knowledge with students.
              </p>
            </div>
